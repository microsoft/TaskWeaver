...
## 🆕 News
- 📅2024-03-19: TaskWeaver now switches to `container` mode by default for code execution. Please check the [code execution](https://microsoft.github.io/TaskWeaver/docs/advanced/code_execution) for more details.🐳
